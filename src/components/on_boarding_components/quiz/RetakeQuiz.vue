<template >
  <v-app>
    ...
    <div class="row">
      <p class="mx-auto largeTitle white--text">
        You're almost there!
      </p>
    </div>
    <div class="row">
      <p class="mx-auto col-md-8  text-center tiny white--text">
          ...
          <div class="col-12 text-center stencilBorder  black--text"> 
            <div class="row">
              ...
              <div class="col-9 col-sm-10">
                ...
                <div class="row">
                  <div class="col-12 medium-small text-left pl-0" v-bind:class="!JSON.parse(questionResults.questionThree) ? 'red--text': 'default'">
