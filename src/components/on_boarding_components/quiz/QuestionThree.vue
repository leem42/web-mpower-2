    ...
    <v-app>
        ...
        <div class="row ml-6">
             <v-radio-group v-model="questionResults.questionThree" class="col-12">
                <div class="row"> 
                    <v-radio class=" col-10  stencilBorder stencilBorderTop pt-3 mt-0 pb-3 wrapLabel lightGrayText pr-0" label="Yes" value="false">  </v-radio>
                    <v-radio class=" col-10  stencilBorder  pt-3 mt-0 pb-3 wrapLabel lightGrayText pr-0" label="No" value="true"> </v-radio>
                </div>
             </v-radio-group> 
        </div>
