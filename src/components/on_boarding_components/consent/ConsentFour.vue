            ...
            <div class="col-md-6 mr-5">
              ...
              <div class="row">
                <ul class="ml-md-5 mr-md-5 smallText lightGrayText">
                  ...
                  <v-btn :to="{name: 'ConsentThree'}" flat :ripple="false" class="navButton col-4  ml-4 ml-sm-5 mr-sm-5 medium white--text text-capitalize">  Back </v-btn>
                  <v-btn :to="{name: 'ConsentFive'}" flat :ripple="false" class="navButton col-4 medium white--text text-capitalize">  Next </v-btn>
              </div>
            </div>    
