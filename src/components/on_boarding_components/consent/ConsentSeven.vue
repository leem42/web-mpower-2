            ...
            <div class="col-md-6 mr-5">
              <div class="row">
                ...
                <div class="mx-auto pt-3 pt-sm-0 col-3 col-lg-2 mr-lg-2 ml-lg-2 customHeight">
                  <img class="img-fluid " src="../../../images/step-7-consent-icon.png">
                </div>
              ...
              <div class="row">
                <ul class="ml-md-5 mr-md-5 smallText lightGrayText">
                  ...
                  <v-btn :to="{name: 'ConsentSix'}" flat :ripple="false" class="navButton col-4  ml-4 ml-sm-5 mr-sm-5 medium white--text text-capitalize">  Back </v-btn>
                  <v-btn :to="{name: 'ConsentEight'}" flat :ripple="false" class="navButton col-4 medium white--text text-capitalize">  Next </v-btn>
              </div>
            </div>    
