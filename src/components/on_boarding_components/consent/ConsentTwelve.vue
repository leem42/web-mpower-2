<template>
    <v-app>
        ...
        <br>
        <div class="row">
            <iframe ref="frame" src="http://localhost:8080/#/NullPage/ConsentDoc" height="500px" class="ml-sm-4 col-md-5 mask">
            </iframe>
            ...
            <div class="col-md-6 mr-5">
              <div class="row">
                ...
                <div class="mx-auto pt-3 pt-sm-0 col-3 col-lg-2 mr-lg-2 ml-lg-2 customHeight">
                  <img class="img-fluid " src="../../../images/step-12-consent-icon.png">
                </div>
              ...
              <div class="row">
                <ul class="ml-md-5 mr-md-5 smallText lightGrayText">
                    ...
                    <li class="mt-lg-1 mb-lg-3">
                        You can pause your participation or you can leave the study at 
                        any time. 
                    </li>

                  <a href="" class="defaultBlue font-weight-bold "><u> Learn More </u></a>
                </ul>
                  <v-btn :to="{name: 'ConsentEleven'}" flat :ripple="false" class="navButton col-4  ml-4 ml-sm-5 mr-sm-5 medium white--text text-capitalize">  Back </v-btn>
                  <v-btn :to="{name: 'ConsentThirteen'}" flat :ripple="false" class="navButton col-4 medium white--text text-capitalize">  Next </v-btn>
              </div>
            </div>    
