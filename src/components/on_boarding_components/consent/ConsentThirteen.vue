            ...
            <div class="col-md-6 mr-5">
              <div class="row">
                ...
                <div class="mx-auto pt-3 pt-sm-0 col-3 col-lg-2 mr-lg-2 ml-lg-2 customHeight">
                  <img class="img-fluid " src="../../../images/step-13-consent-icon.png">
                </div>
              ...
              <div class="row">
                <ul class="ml-md-5 mr-md-5 smallText lightGrayText">
                  ...
                  <li class="mt-lg-1 mb-lg-3">
                    Take time to think it over and ask questions.
                  </li>
                  ...
                  <v-btn v-on:click="[requirements.isOnConsent = false, requirements.hasCompletedConsent = true , requirements.isOnQuiz = true, $router.push({name: 'OverviewEligibility'})]" flat :ripple="false" class="navButton col-4 medium white--text text-capitalize">  Next </v-btn>
              </div>
            </div>    
