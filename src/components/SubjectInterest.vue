<template>
  <v-app>
    ...
    <div class="row" id="controller">
      <v-btn id="next" class="darkPurple mx-auto" @click.native="handleController()"> {{!thirdClick ? "Next": "Submit"}} </v-btn>
    </div>
    <div class="row">
