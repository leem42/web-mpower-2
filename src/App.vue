      ...
      <div class="container-fluid" style="display: block;">
        <div class="row">
          ...
          <div class="col-12 pl-1 text-center text-sm-left col-md-4">
            <h1 class="lead light tiny" id="status"> Eligibility </a>
            </h1>
          </div>
...
.border {
  border-radius: 50%; // background-color: rgba(65, 73, 90, 0.1);
  background-color: whitesmoke;
  top: 50% !important; // padding: 8px;
  padding-top: 3px;
  padding-right: 13px;
  height: 55px;
  width: 55px;
...
.round {
  ...
  text-align: center !important;
  box-shadow: none; // font-family: "San Francisco Text" !important;
}
